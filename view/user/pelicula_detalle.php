    ...
    <div class="contenedor_horarios">
        ...
        <div class="contenedor_horario">
            ...
            <?php foreach($funciones as $funcion){ 
                ...
                <form action="<?php echo constant("URL"); ?>user/operacionSession/idFuncion" method="POST">
                    <input style="display:none" type="text" name="id_funcion" value="<?php echo $funcion->getId(); ?>"></input>
                    <input type="submit" value="<?php echo hora($funcion->getMinutos_inicio()); ?>" class="contenedor_horario_elemento"></input>
                </form>
            <?php } 
            } ?>
        </div>
